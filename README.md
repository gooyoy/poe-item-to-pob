...
![市集页效果](https://raw.githubusercontent.com/gooyoy/poe-item-to-pob/main/docs/screenshot-trade.png)

**游戏内复制** — 游戏里鼠标悬停装备按 `Ctrl+C`，切到浏览器按 `Alt+V` 打开面板，粘贴后自动转换。

![转换面板](https://raw.githubusercontent.com/gooyoy/poe-item-to-pob/main/docs/screenshot-panel.png)
